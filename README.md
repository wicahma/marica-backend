...
- **Method** : PUT
- **URL** : /user/password
- **Description** : Untuk mengupdate Password User
- **Access** : Admin & Orangtua
- **Auth** : Yes
- **Params** : -
- **Query** : -
- **Body** : newPass, oldPass
- **Session** : id (user id)
...
- **Method** : DELETE
- **URL** : /user/logout
- **Description** : Untuk menghapus session user
- **Access** : Admin & Orangtua
- **Auth** : Yes
- **Params** : -
- **Query** : -
...
### **Anak Routing** _(Inherited from User Routing)_
...
#### **- Delete One Data Anak**

- **Method** : DELETE
- **URL** : /user/anak?idAnak=**id**
- **Description** : Untuk menghapus 1 data anak yang ada pada satu orangtua
- **Access** : Admin & Orangtua
- **Auth** : Yes
- **Params** : -
- **Query** : idAnak
...
#### **- Get Liked Video by Anak**

- **Method** : GET
- **URL** : /user/anak/**:idAnak**/like-history
- **Description** : Untuk mengambil data video yang pernah disukai anak
- **Auth** : Yes
- **Params** : idAnak
- **Query** : -
- **Body** : -
...
- **Method** : GET
- **URL** : /video
- **Description** : Mengambil Data Video
- **Access** : Admin & Orangtua
- **Auth** : Yes
- **Params** : -
- **Query** : -
...
- **Method** : GET
- **URL** : /video?id=**id**
- **Description** : Mengambil 1 Data Video
- **Access** : Admin & Orangtua
- **Auth** : Yes
- **Params** : -
- **Query** : id (ID Video)
...
- **Params** : -
- **Query** : -
- **Body** : videoURL, thumbnail, type, quizTimestamp, ?quizType, ?quiz, ?quizAttachmentData, ?quizAttachmentType,
- **Session** : Yes
...
- **Method** : PUT
- **URL** : /video/:id
- **Description** : Memperbarui Data Video
- **Access** : Admin
- **Auth** : Yes
- **Params** : -
- **Query** : -
- **Body** : thumbnail, ?quizTimestamp, ?quizType, ?quiz, ?quizAttachmentData, ?quizAttachmentType,
- **Session** : Yes
...
- **Method** : DELETE
- **URL** : /video/:id
- **Description** : Menghapus data video
- **Access** : Admin
- **Auth** : Yes
- **Params** : -
- **Query** : -
...
- **Method** : PUT
- **URL** : /video/:id/like?type=**type**
- **Description** : Menyukai data video & menambahkannya ke list video yang disukai di akun anak, 

_(jika type ditulis, dia akan melakukan operator sesuai inputan, jika type tidak ditulis, maka nantinya ia akan menghapus data riwayat like / dislike yang telah dibuat)_
